...
const externalNavigation = [
  { name: 'Hochzeitsdetails', href: '/gateway/apps/69d1f2b19917a46e1f788830?template=list_page', icon: IconFileText },
  { name: 'Gästeliste', href: '/gateway/apps/69d1f2b7ecfc2c3b0c09b767?template=list_page', icon: IconFileText },
  { name: 'Dienstleister', href: '/gateway/apps/69d1f2b83e1d3b28aad7445e?template=list_page', icon: IconFileText },
  { name: 'Locations', href: '/gateway/apps/69d1f2b90fca651e71fbc8be?template=list_page', icon: IconMapPin },
  { name: 'Budgetplanung', href: '/gateway/apps/69d1f2bab40ae06e4b2f1e7a?template=list_page', icon: IconFileText },
  { name: 'Aufgaben & To-Dos', href: '/gateway/apps/69d1f2bb3b04163152b57515?template=list_page', icon: IconSquareCheck },
  { name: 'Zeitplan & Ablauf', href: '/gateway/apps/69d1f2bcb64b3f58f4c2d8fd?template=list_page', icon: IconFileText },
  { name: 'Tischplan', href: '/gateway/apps/69d1f2bcf7e69465f268e88e?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69d1f2b19917a46e1f788830?template=list_page"
